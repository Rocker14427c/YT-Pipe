...
public abstract class BasePreferenceFragment extends PreferenceFragmentCompat {
    ...
    public void onViewCreated(@NonNull final View rootView,
        ...
        rootView.setBackgroundColor(ThemeHelper.resolveColorFromAttr(requireContext(),
                org.schabi.newpipe.R.attr.windowBackground));
        setDivider(ContextCompat.getDrawable(requireContext(),
                org.schabi.newpipe.R.drawable.yt_preference_divider));
        setDividerHeight(1);
